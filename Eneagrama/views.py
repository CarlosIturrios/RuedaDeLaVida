...
class ReporteExcel(TemplateView):
    def get(self, request, *args, **kwargs):
        ...
        msg.attach("Reporte_Eneagrama_{0}_{1}.xlsx".format(evaluacion.usuario.nombre, evaluacion.usuario.apellidos), output.getvalue(), 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')
